  ...
  constructor(internal) {
    ...
    this.currentState = {
      internal: {
        ...
        plan_times: [],
        services_list: [
          { id: "", label: "No Services loaded. Update instance config." },
        ],
        services_withorg_list: [
          { id: "0", label: "No Services loaded. Update instance config." },
        ],
        plans_list: [
          { id: "", label: "No Plans loaded. Update instance config." },
        ],
