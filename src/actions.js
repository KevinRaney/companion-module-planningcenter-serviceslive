...
module.exports = {
  initActions() {
    ...
    actions.nextitem_specific = {
      ...
      callback: async function (event) {
        let serviceTypeId = await self.parseVariablesInString(
          event.options.servicetypeid,
        );
    ...
    actions.restart_interval = {
      ...
      description:
        "Restarts the internal timer that request new data from PCO periodically.",
      options: [],
      callback: async function (event) {
        self.startInterval();
      },
    ...
    actions.stop_interval = {
      name: "Stop Interval",
      description:
        "Stops the internal timer that request new data from PCO periodically.",
      options: [],
      callback: async function (event) {
        self.stopInterval();
      },
