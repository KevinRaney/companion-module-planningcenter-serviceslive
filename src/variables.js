module.exports = {
  initVariables() {
    ...
    let variables = [
      ...
      {
        variableId: "plan_currentitem_time_length",
        name: "Plan Current Item Time Length",
      },
      {
        variableId: "plan_currentitem_time_started",
        name: "Plan Current Item Time Started",
      },
      {
        variableId: "plan_currentitem_time_remaining",
        name: "Plan Current Item Time Remaining",
      },
      {
        variableId: "plan_currentitem_time_remaining_seconds",
        name: "Plan Current Item Time Remaining Seconds",
      },
      {
        variableId: "plan_currentitem_time_shouldfinish",
        name: "Plan Current Item Time Should Finish",
      },
      { variableId: "plan_currentitem_key", name: "Plan Current Item Key" },
      {
        variableId: "plan_currentitem_description",
        name: "Plan Current Item Description",
      },

      { variableId: "plan_nextitem", name: "Plan Next Item" },
      {
        variableId: "plan_nextitem_time_length",
        name: "Plan Next Item Time Length",
      },
      { variableId: "plan_nextitem_key", name: "Plan Next Item Key" },
      {
        variableId: "plan_nextitem_description",
        name: "Plan Next Item Description",
      },

      {
        variableId: "last_servicetype_id",
        name: "Last Controlled Service Type Id",
      },
      {
        variableId: "last_servicetype_name",
        name: "Last Controlled Service Type Name",
      },
    ...
    if (self.scheduledPeople.length > 0) {
      ...
      self.scheduledPeople.forEach((person) => {
        ...
        let positionNameId = positionName
          .replace(/[^a-zA-Z0-9]/g, "")
          .toLowerCase();
        ...
        let positionPhotoThumbnailVariable = {
          variableId:
            "scheduled_position_" + positionCount + "_photo_thumbnail",
        ...
        let teamPositionNumberVariable = {
          variableId:
            "scheduled_" + teamNameId + "_position_" + teamPositionCount,
        ...
        let teamPositionStatusNumberVariable = {
          variableId:
            ...
            "_status",
          name:
            teamName + ": Scheduled Position " + teamPositionCount + " Status",
        };
        ...
        teamPositionStatusVariable.variableId =
          teamPositionVariable.variableId + "_status";
        teamPositionStatusVariable.name = teamPositionVariable.name + " Status";

        teamPositionPhotoThumbnailVariable.variableId =
          teamPositionVariable.variableId + "_photo_thumbnail";
        teamPositionPhotoThumbnailVariable.name =
          teamPositionVariable.name + " Photo Thumbnail";
  ...
  checkVariables() {
    ...
    try {
      ...
      variableObj.org_name =
        this.currentState.dynamicVariables.organization_name;
      ...
      variableObj.plan_currentitem =
        this.currentState.dynamicVariables.plan_currentitem;
      variableObj.plan_currentitem_time_length =
        this.currentState.dynamicVariables.plan_currentitem_time_length;
      variableObj.plan_currentitem_time_started =
        this.currentState.dynamicVariables.plan_currentitem_time_started;
      variableObj.plan_currentitem_time_remaining =
        this.currentState.dynamicVariables.plan_currentitem_time_remaining;
      ...
      variableObj.plan_currentitem_key =
        this.currentState.dynamicVariables.plan_currentitem_key;
      variableObj.plan_currentitem_description =
        this.currentState.dynamicVariables.plan_currentitem_description;

      variableObj.plan_nextitem =
        this.currentState.dynamicVariables.plan_nextitem;
      variableObj.plan_nextitem_time_length =
        this.currentState.dynamicVariables.plan_nextitem_time_length;
      variableObj.plan_nextitem_key =
        this.currentState.dynamicVariables.plan_nextitem_key;
      variableObj.plan_nextitem_description =
        this.currentState.dynamicVariables.plan_nextitem_description;

      variableObj.last_servicetype_id = this.lastServiceTypeId;
      variableObj.last_servicetype_name = this.lastServiceTypeId
        ? this.currentState.internal.services.find(
            (service) => service.id === this.lastServiceTypeId,
          )?.attributes?.name
        : "";
      variableObj.last_plan_id = this.lastPlanId;
      variableObj.last_plan_name = this.lastPlanId
        ? this.currentState.internal.plans.find(
            (plan) => plan.id === this.lastPlanId,
          )?.attributes?.dates
        : "";
      ...
      if (self.scheduledPeople.length > 0) {
        ...
        self.scheduledPeople.forEach((person) => {
          ...
          variableObj["scheduled_position_" + positionCount + "_status"] =
            personStatus;
          variableObj["scheduled_position_" + positionCount + "_position"] =
            positionName;
          variableObj[
            "scheduled_position_" + positionCount + "_photo_thumbnail"
